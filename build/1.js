...
var AddonMessagesIndexPage = /** @class */ (function () {
    ...
    AddonMessagesIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-messages-index',template:/*ion-inline-start:"C:\Users\Boubacar Sidy Diallo\Desktop\sauvegarde SG\moodlemobile2\src\addon\messages\pages\index\index.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{ \'addon.messages.messages\' | translate }}</ion-title>\n\n        <ion-buttons end></ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<core-split-view>\n\n    <ion-content>\n\n        <core-tabs>\n\n            <core-tab [title]="\'addon.messages.messages\' | translate" icon="chatbubbles">\n\n                <ng-template>\n\n                    <addon-messages-discussions></addon-messages-discussions>\n\n                </ng-template>\n\n            </core-tab>\n\n            <core-tab [title]="\'addon.messages.contacts\' | translate" icon="person">\n\n                <ng-template>\n\n                    <addon-messages-contacts></addon-messages-contacts>\n\n                </ng-template>\n\n            </core-tab>\n\n        </core-tabs>\n\n    </ion-content>\n\n</core-split-view>'/*ion-inline-end:"C:\Users\Boubacar Sidy Diallo\Desktop\sauvegarde SG\moodlemobile2\src\addon\messages\pages\index\index.html"*/,
        }),
